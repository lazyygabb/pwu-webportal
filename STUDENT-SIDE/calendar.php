...
<head>
  ...
  <link rel="stylesheet" href="../STUDENT-SIDE-CSS/calendar.css">
  <link rel="icon" type="pwu-logo" href="../pictures/PWU LOGO.png">
  <script src="../STUDENT-SIDE-JS/calendar.js" defer></script>
  <title>WELCOME</title>
</head>
<body>
   <nav id="sidebar">
  ...
  <div class="main-content">
    <header class="site-header-1">
      <div class="container-header-1">
        <div class="wrapper-header-1">
          <img class="pwu-logo-1" src="../pictures/PWU LOGO.png" alt="PWU Logo">
          <label class="h2-pwu-1">Philippine Women's University Calamba</label>
        </div>
      </div>
    ...
    <div class="page-content-1">
      <div class="container-calendar">
        <header>
          <h1 class="calendar-h2">Upcoming Events & Holidays</h1>
        </header>
